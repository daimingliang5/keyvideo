    ...
    <>
      <header className="py-8 text-center relative">
        <div className="flex justify-center gap-6 mb-8">
          <Link href="/">
            <button className="px-8 py-4 bg-[#222428] text-[#E5E5E5] rounded-2xl font-medium transition-all duration-300 hover:bg-[#3A3C3E] flex items-center gap-3 text-lg" style={{ border: '1px solid rgba(255, 255, 255, 0.1)' }}>
              🎬 视频生成工具
            </button>
          </Link>
          <Link href="/image-generator">
            <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-2xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/20 flex items-center gap-3 text-lg" style={{ border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              🎨 图像生成工具
            </button>
          </Link>
        </div>
          ...
          <div className="bg-[#222428] rounded-3xl p-10 max-w-md w-full mx-4 border border-white/10 shadow-2xl" onClick={(e) => e.stopPropagation()} style={{ boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)' }}>
            <div className="flex justify-between items-start mb-8">
              <div className="text-center flex-1">
                <div className="w-20 h-20 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-5" style={{ boxShadow: '0 0 30px rgba(34, 211, 238, 0.3)' }}>
            ...
            <div className="space-y-5">
              {isRegisterMode && (
                <input
                  ...
                  placeholder="请输入用户名"
                  className="w-full bg-[#1A1C1E] border border-white/10 rounded-xl px-5 py-4 text-[#E5E5E5] placeholder-[#666] focus:outline-none focus:border-cyan-500 transition-all text-base"
                />
              )}
              <input
                type="email"
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl font-bold transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/20 disabled:opacity-50 disabled:cursor-not-allowed text-lg"
              >
